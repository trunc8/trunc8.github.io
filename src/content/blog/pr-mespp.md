...
pubDate: 2021-04-01
description: "Review of MILP-based models for the Multi-robot Efficient Search Path Planning problem"
ogImage: /img/content/pr-mespp/Banner.png
theme: "Paper Reviews"
tags: []
mathjax: true
draft: false
...
- $\mathbf{C}^{s,u}$ is the (n+1)x(n+1) capture matrix. It represents which vertices of the graph fall within the sensing range of searcher s, when s is located in vertex u. The subscript refers to the location in the capture matrix
