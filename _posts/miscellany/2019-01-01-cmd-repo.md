...
1. [Edit pdf](#edit-pdf)
1. [Speed-up Video](#speed-up-video-by-2x)
1. [Benchbot Commands](#benchbot-commands)
1. [ROS2 Commands](#ros2-commands)
1. [Python Commands](#python-commands)
1. [Git Commands](#git-commands)
1. [Docker Commands](#docker-commands)
1. [Markdown Snippets with Renderings](#markdown-snippets-with-renderings)
1. [Acknowledgements](#acknowledgements)

### Terminal tools
```sh
# Replace "/home/trunc8d/catkin_ws/src/chaos" with "$(find chaos)" 
# in all files recursively under current directory
# (Using grep)
grep -rl "/home/trunc8d/catkin_ws/src/chaos" . | xargs sed -i 's/\/home\/trunc8d\/catkin_ws\/src\/chaos/\$\(find chaos\)/g'

# Replace 'category: scribbles' with 'category: ""'
# (Using rg)
