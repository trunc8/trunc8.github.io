...
projects:
  - title: Quadruped Robot
    image:
      src: /assets/img/projects/stride.png
      alt: 
  ...
  - title: Two-wheeled Self-Balancing Bot
    image:
      src: /assets/img/projects/self-balancing-bot.jpg
      alt: 
  ...
  - title: Autonomous Drone Exploration
    image:
      src: /assets/img/projects/interiit.png
      alt: 
    description: (Team leader in <i>Inter IIT Tech Meet '21</i>) Simulated quadrotor capable of navigating in a complex static environment by avoiding on-field obstacle-collision and reaching the target destination after its correct detection
  ...
  - title: International Micromouse Challenge
    image:
      src: /assets/img/projects/comp-imc.png
      alt: 
  ...
  - title: Automated Graph Reader
    image:
      src: /assets/img/projects/auto-graph-reader-demo.png
      alt: 
  ...
  - title: Panoramic Mosaicing
    image:
      src: /assets/img/projects/panorama.jpg
      alt: 
  ...
  - title: Image Quilting
    image:
      src: /assets/img/projects/default.jpg
      alt: 
    description: This achieves <i>Texture Transfer</i> using simple memoization-based Image Quilting technique (where people are nowadays using deep learning techniques). The <i>Texture Synthesis</i> implementation is useful for creating background in video games with cheap computation.
  ...
  - title: Conway’s Game of Life
    image:
      src: /assets/img/projects/default.jpg
      alt: 
    description: Terminal based game of the hacker's favorite game, and provided with unittesting.
  ...
  - title: Labyrinth CMake app
    image:
      src: /assets/img/projects/default.jpg
      alt: 
    description: CMakeLists based app to find the longest route in a text map
  ...
  - title: Sudoku Solver Using Block Printing
    image:
      src: /assets/img/work/default.jpg
      alt: 
